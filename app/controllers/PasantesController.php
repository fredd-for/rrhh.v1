	...
	public function formularioregistroAction($id=0)
     {
        ...
        $documentos= parametros::find(array("parametro='pasantes_documentacion' and baja_logica=1"));
          ...
          $pdf->SetXY(90,200);
          $pdf->MultiCell(115, 6, utf8_decode('Con la firma al pie del presente formulario, me compremeto a cumplir con lo establecido en el convenio entre mi Universidad y la Empresa de Transporte por Cable "MI TELEFERICO".'), 'TR', 'J', 0);
          $pdf->SetXY(90,200);
