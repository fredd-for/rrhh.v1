...
class MisencuestasController extends ControllerBase
{
    ...
    public function indexAction()
    {
        ...
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.tab.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.index.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.list.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.finish.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.new.edit.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.view.js');
        $this->assets->addJs('/js/misencuestas/oasis.misencuestas.view.splitter.js');
            ...
            if (count($result) > 0) {
                foreach ($result as $v) {
                    $pregresp[] = array(
                        ...
                        'pregunta_codigo' => $v->pregunta_codigo,
                        'pregunta' => $v->pregunta,
