...
class ControlexcepcionesvistobuenoController  extends ControllerBaseOut{
    ...
    public function vistobuenoAction($idRelaboralSolicitanteCodificado=null,$idRelaboralDestinatarioPrincipalCodificado=null,$idRelaboralDestinatarioSecundarioCodificado=null,$idControlExcepcionCodificado=null,$estadoCodificado=null){
        ...
        switch($estadoSolicitado){
            case 3:
            case 5:$accionSolicitada = "VERIFICACI&Oacute;N SOLICITUD DE EXCEPCI&Oacute;N";
                break;
            case 6:$accionSolicitada = "APROBACI&Oacute;N SOLICITUD DE EXCEPCI&Oacute;N";
                break;
            case -1:$accionSolicitada = "RECHAZAR SOLICITUD DE VERIFICACI&Oacute;N";
                break;
            case -2:$accionSolicitada = "RECHAZAR SOLICITUD DE APROBACI&Oacute;N";
                break;
        }
        $this->view->disable();
        ...
        if($idRelaboralSolicitante>0&&$idRelaboralDestinatarioPrincipal>0&&$idControlExcepcion>0){
            ...
            if(is_object($controlexcepcion)
                &&($controlexcepcion->controlexcepcion_estado==3
                    ...
                    /**
                     * En caso de haberse presentado un error técnico en el envío, debe admitire registros de este tipo
                     */
                    ||$controlexcepcion->controlexcepcion_estado==-3
                    ||$controlexcepcion->controlexcepcion_estado==-4
                )
                ...
                if($cantidadDiasTranscurridos<=$cantidadDeDiasAdmitidos){
                    ...
                    if(is_object($usuarioDestinatarioPrincipal)){
                        ...
                        if(is_object($contactoDestinatarioPrincipal)&&$contactoDestinatarioPrincipal->e_mail_inst!=''&&$contactoDestinatarioPrincipal->e_mail_inst!=null){
                             ...
                             */
                            $username = str_replace("@miteleferico.bo","",$contactoDestinatarioPrincipal->e_mail_inst);
                            $password = hash_hmac('sha256', trim($relaboralDestinatarioPrincipal->ci), '2, 4, 6, 7, 9, 15, 20, 23, 25, 30');
                    ...
                    if(is_object($usuarioDestinatarioPrincipal)){
                        ...
                        switch($estadoSolicitado){
                            ...
                            case 5:
                                ...
                                if($ok){
                                    /**
                                     * En caso de haberse aprobado la excepción, se envía un correo solicitando la APROBACIÓN
                                     */

                                    $operacion=2;
                                    $mensajeAdicional=utf8_decode("Se envío de manera automática la solicitud de Aprobación.");
                    ...
                    if($ok){
                        ...
                        $cuerpo .= '</div>';
                        $cuerpo .= '</div>';
                        if($controlexcepcion->tipoexcepcion_id==2){
                            $cuerpo .= '<div class="form-group">';
                            $cuerpo .= '<div class="col-md-3">';
                        ...
                        $cuerpo.='<h4>Error!</h4>';
                        $cuerpo.='<span id="spanAlertError">e ha presentado un error en la solicitud de la operaci&oacute;n, cont&aacute;ctese con el Administrador.</span>';
                        $cuerpo.='</div>';
                        $cuerpo .= '<form action="" method="post" class="form-bordered" onsubmit="return false;">';
                        $cuerpo .= '<div style="text-align: center" id="divContador"><span id="spanContador">La pesta&ntilde:a se cerrar&aacute; en <b id="bContador"></b> segundos.</span></div>';
                        $cuerpo .= '<div class="form-group form-actions">';
                    ...
                    $cuerpo.='<div class="alert alert-danger" id="divAlertError">';
                    $cuerpo.='<h4>Error!</h4>';
                    $cuerpo.='<span id="spanAlertError">El tiempo admitido para realizar la operaci&oacute;n (".$cantidadDeDiasAdmitidos." d&iacute;a(s)) se ha superado, por lo que ya no se puede realizar la operaci&oacute;n.</span>';
                    $cuerpo.='</div>';
                    $cuerpo .= '<form action="" method="post" class="form-bordered" onsubmit="return false;">';
                    $cuerpo .= '<div style="text-align: center" id="divContador"><span id="spanContador">La pesta&ntilde:a se cerrar&aacute; en <b id="bContador"></b> segundos.</span></div>';
                    $cuerpo .= '<div class="form-group form-actions">';
                ...
                if(is_object($controlexcepcion)){
                    ...
                    if(is_object($parametro)){
                        ...
                        if($ok){
                            ...
                            $cuerpo .= '<div class="col-md-8">';
                            $cuerpo .= '<div class="block">';
                            $cuerpo .= '<h3>BOLETA DE EXCEPCI&Oacute;N<br><small id="smallRecomendacion"> C&oacute;digo:'.$prefijo.$objCorr->numero."-".$gestion.'</small></h3>';
                            $cuerpo .= '<form action="" method="post" class="form-bordered" onsubmit="return false;">';
                            $cuerpo .= '<div class="form-group">';
                            $cuerpo .= '<div class="col-md-3">';
                            $cuerpo .= '<span>Solicitante:</span>';
        ...
        if(is_object($controlexcepcion)&&is_object($relaboralSolicitante)) {
            ...
            if(is_object($contactoRemitente)){
                ...
                if ($controlexcepcion->controlexcepcion_estado == 1
                    ...
                    $cuerpo .= '</table></td>';
                    $cuerpo .= '</tr>';
                    $cuerpo .= '</table></td></tr></table></div></br><div id="divPieMensaje"></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br></br>'.$mensajePie.'</div></body></html>';
        ...
        if(is_object($controlexcepcion)&&is_object($relaboralSolicitante)) {
            ...
            if(is_object($contactoRemitente)){
                ...
                if ($controlexcepcion->controlexcepcion_estado == 4
                    ...
                    if ($departamentoDestinatarioSecundario != '') {
                        $cuerpo .= '<tr>';
                        $cuerpo .= '<td style="font-family: Helvetica LT Condensed; font-size: 12px;"><spanHelvetica LT Condensed"; font-size: 12px;"><span style="font-weight: bold">Departamento:</span>&nbsp; ' . $departamentoDestinatarioSecundario . '</span> &nbsp; <spanHelvetica LT Condensed"; font-size: 12px;">&nbsp;</span></td>';
                        $cuerpo .= '</tr>';
                    }
                    if ($gerenciaDestinatarioSecundario != '') {
                        $cuerpo .= '<tr>';
                        $cuerpo .= '<td style="font-family: Helvetica LT Condensed; font-size: 12px;"><spanHelvetica LT Condensed"; font-size: 12px;"><span style="font-weight: bold">Gerencia:</span>&nbsp; ' . $gerenciaDestinatarioSecundario . '</span> &nbsp; <spanHelvetica LT Condensed"; font-size: 12px;">&nbsp;</span></td>';
                        $cuerpo .= '</tr>';
                    }
                    $cuerpo .= '<tr>';
                    $cuerpo .= '<td style="font-family: Helvetica LT Condensed; font-size: 12px;"><span style="font-weight: bold">Tipo de Excepci&oacute;n:</span>&nbsp; ' . $excepcion . '</td>';
                   ...
                   $cuerpo .= '</tr>';
                    ...
                    if($departamentoSolicitante!=''){
                        $cuerpo .= '<tr>';
                        $cuerpo .= '<td style="font-family: Helvetica LT Condensed; font-size: 12px;"><span style="font-weight: bold">Departamento Solicitante:</span>&nbsp; ' . $departamentoSolicitante . '</td>';
                        $cuerpo .= '</tr>';
                    }

                    if($gerenciaSolicitante!=''){
                        $cuerpo .= '<tr>';
                        $cuerpo .= '<td style="font-family: Helvetica LT Condensed; font-size: 12px;"><span style="font-weight: bold">Gerencia Destinatario:</span>&nbsp; ' . $gerenciaSolicitante . '</td>';
                        $cuerpo .= '</tr>';
                    }
                    if($fechaYHoraEnvio!=''){
                        $cuerpo .= '<tr>';
