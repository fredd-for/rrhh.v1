...
=======
<<<<<<< HEAD
>>>>>>> 4a826c19198b43884e28891d6640881b576ed0c0
<?php
/*
...
>>>>>>> 4a826c19198b43884e28891d6640881b576ed0c0
    ...
    {   $this->view->setMainView('recover');
        ...
        if(count($arrEmail)==2&&$dominio=="miteleferico.bo"){
            ...
            if(is_object($contacto)){
                ...
                if(is_object($relaboral)){
                    ...
                    $username = str_replace("@miteleferico.bo","",$contacto->e_mail_inst);
                    ...
                    if($oku){
                        ...
                        $mensajeCabecera .= "Usted ha solicitado la operaci&oacute;n de <b>".$operacionSolicitada."</b> ";
        ...
        }else $msj = array('result' => -4, 'msj' => 'El dato enviado no corresponde a un correo electr&oacute;nico v&aacute;lido. Tiene que tener la forma "micuenta@miteleferico.bo".');
