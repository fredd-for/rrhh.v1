...
class PlanillassalController extends ControllerBase{
    ...
    public function indexAction()
    {
        ...
        $this->assets->addJs('/js/planillassal/oasis.planillassal.generate.js');
        $this->assets->addJs('/js/planillassal/oasis.planillassal.edit.js');
        $this->assets->addJs('/js/planillassal/oasis.planillassal.view.js');
