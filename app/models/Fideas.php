...
class Fideas extends \Phalcon\Mvc\Model  {
    ...
    /**
     * Función para la obtención del listado de ideas de negocio registradas por una persona en una determinada gestión. En caso de enviarse en el parámetro gestión el valor de cero, se retorna todos los registros.
     * @param $idPersona
     * @param $gestion
     * @param string $where
     * @param string $group
