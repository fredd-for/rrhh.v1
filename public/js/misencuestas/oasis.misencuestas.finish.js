 ...
 */
/**
 * Función para concluir un registro de la Encuesta.
 */
function concluirRegistroDeEncuesta(idEncuesta){
    var ok = false;
    $.ajax({
        url:'/misencuestas/finish/',
        type:'POST',
        datatype: 'json',
        async:false,
        data:{id:idIdea},
        success: function(data) {
            ...
            if(res.result==1){
                ...
                $("#divGridEncuesta").jqxGrid("updatebounddata");
                ok=true;
