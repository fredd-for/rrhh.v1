/**
 * Funcion para inicializar la paleta de colores en una determinada caja de texto identificada por el parámetro enviado.
 * @param cajaColor
 */
function inicializarPaleta(cajaColor){
    ...
    function displayPicker(input) {
        ...
        activarControles(cajaColor);
    };

    /*$(".kolorPicker").on("click", function () {*/
    cajaColor.on("click", function () {
    ...
    cajaColor.on("keypress", function (e) {
...
/**
 * Función para activar los controles necesarios ante cambios sobre la paleta de colores.
 */
function activarControles(cajaColor){
    $('.x-close-box').on("click", function(){
        cleanPicker();
    });
    $(".tile").on("click", function(){
        ...
        $(input).change();
        /**
         * Luego de establecerse el color se cambia el color del fondo del input
         */
        /*var color = $(".kolorPicker").val();
        $(".kolorPicker").css({'background-color' : color,'color' : color});*/
        var color = cajaColor.val();
        cajaColor.css({'background-color' : color,'color' : color});
    });
    $("ul.palette-select li").on("click", function(){
