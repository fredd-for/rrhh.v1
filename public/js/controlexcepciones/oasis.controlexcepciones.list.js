        ...
        $("#divGridControlExcepciones").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    $("#approveexceptrowbutton").on('click', function () {
                     ...
                     if (dataRecord.controlexcepcion_estado != 6 && dataRecord.controlexcepcion_estado > 0) {
                     if (confirm("¿Esta seguro de aprobar este registro?")) {
                         aprobarRegistroControlExcepcion(dataRecord.id);
                     }
                     } else {
                         var msje = "Debe seleccionar un registro que no este APROBADO, ni RECHAZADO o PASIVO para posibilitar la aprobaci&oacute;n del registro";
