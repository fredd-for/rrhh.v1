 ...
 * @param observacion
 */
function inicializarFormularioGestionIdeasNewEdit(opcion,idRelaboral,idIdea,gestion,mes,tipoNegocio,titulo,resumen,descripcion,inversion,beneficios,puntuacion_a,puntuacion_b,puntuacion_c,puntuacion_c,puntuacion_d,puntuacion_e,observacion){
    var sufijo="New";
 ...
 */
function guardaGestionIdeas(opcion) {
    var ok = false;
    var idIdea = 0;
    var sufijo = "New";
    if (opcion == 2) {
