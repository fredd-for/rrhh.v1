 ...
 */
/**
 * Función para la definición de la grilla que contiene la lista de registros de Ideas de Negocio.
 * @param dataRecord
 */
function definirGrillaParaListaGestionIdeasPorPersona(dataRecordMain) {
        ...
        $("#divGridGestionIdeas").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    /*container.append("<button title='Clasificar Idea de Negocio.' id='qualifyidearowbutton'  class='btn btn-sm btn-primary' type='button' ><i class='fa fa-star fa-2x text-info' title='Calificar registro'></i> Clasificar</button>");*/
                    ...
                    $("#refreshidearowbutton").on('click', function () {
                        $("#divGridGestionIdeas").jqxGrid("updatebounddata");
                    });
                    /* Ver registro.*/
                    $("#viewidearowbutton").off();
                    $("#viewidearowbutton").on('click', function () {
                        var selectedrowindex = $("#divGridGestionIdeas").jqxGrid('getselectedrowindex');
                        if (selectedrowindex >= 0) {
                            var dataRecord = $('#divGridGestionIdeas').jqxGrid('getrowdata', selectedrowindex);
                        ...
                        if (selectedrowindex >= 0) {
                            ...
                            if (dataRecord != undefined) {
                                ...
                                if (dataRecord.estado == 2) {
                                    $('#popupCalificacion').modal('show');
                                } else {
                                    var msje = "Para calificar un registro, este debe estar en estado CONCLUIDO necesariamente.";
                                    $("#divMsjePorError").html("");
                                    $("#divMsjePorError").append(msje);
                                    $("#divMsjeNotificacionError").jqxNotification("open");
                                }
