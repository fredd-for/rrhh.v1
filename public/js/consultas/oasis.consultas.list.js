        ...
        $("#divGridControlExcepciones").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    $("#turnexceptrowbutton").on("click",function(){
                            ...
                            $("#calendar").html("");
                            var arrFechasPorSemana = iniciarCalendarioLaboralPorRelaboralTurnosAndExcepcionesParaVerAsignacionesPersonales(dataRecordRelaboral,idRelaboral,5,idPerfilLaboral,tipoHorario,arrHorariosRegistrados,defaultGestion,defaultMes,defaultDia);
