 ...
 *   Fecha Creación:  14-09-2014
 */
$().ready(function () {

    $('#divTabControlExcepciones').jqxTabs('theme', 'oasis');
    ...
    cargarDatosControlExcepciones(dataRecordMain);
    ...
    $("#liExcept").on("click",function () {
        ...
        $('#divTabControlExcepciones').jqxTabs('disableAt', 2);
        $('#divTabControlExcepciones').jqxTabs('disableAt', 3);
        $('#divTabControlExcepciones').jqxTabs({selectedItem: 0});
    });
...
function OperaEvento(evento) {
    if ((evento.type == "keyup" || evento.type == "keydown") && evento.which == "27") {
        ...
        $('#tabControlExcepciones').jqxTabs('enableAt', 3);
...
/**
 * Función para la carga de datos referentes al control de excepciones para una persona en particular, considerando su contrato.
 * @param id_relaboral
 * @param id_persona
 * @param nombres
 * @param ci
 */
function cargarDatosControlExcepciones(dataRecordMain){
    ...
    cargarPersonasContactosControlExcepciones(2,dataRecordMain.id_persona);
    $("#hdnIdRelaboralVistaTurnAndExcept").val(dataRecordMain.id_relaboral);
    $("#hdnSwPrimeraVistaHistorialTurnAndExcept").val(0);
    definirGrillaParaListaControlExcepcionesPorIdRelaboralPersona(dataRecordMain);
}
/**
